...
{{ image: ../images/article/70-Exploring-Scanning-of-Color-Negatives-3.jpg | 2007年在公园看到的正在拍照的一家三口（这张是去色罩后的原片，未做白平衡与其它任何调整） }}
{{ image: ../images/article/70-Exploring-Scanning-of-Color-Negatives-1.jpg | 这张使用曲线工具简单调色 }}
